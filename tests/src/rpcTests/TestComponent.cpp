/*
 * Component implementation template for 'rpcTests.TestComponent'.
...
public:
	...
	// ------ rpcTests.IComplexTypes Methods ------ //

	const rpcTests::StringNativeClass& getStringNativeClass()
	{
		return _stringNativeClass;
	}

	void setStringNativeClass( const rpcTests::StringNativeClass& stringNativeClass )
	{
		_stringNativeClass = stringNativeClass;
	}

	const rpcTests::MotherStruct& getMotherStruct()
	{
		return _motherStruct;
	}

	void setMotherStruct( const rpcTests::MotherStruct& motherStruct )
	{
    ...
    void setParentSimple( rpcTests::ISimpleTypes* simple )
    {
        _storedParentSimple = simple;
    }
    
    rpcTests::ISimpleTypes* getSimple()
    {
        return _storedSimple.get();
    }
    
    rpcTests::ISimpleTypes* getParentSimple()
    {
	...
	double callDivideDouble( rpcTests::ISimpleTypes* service, double dividend, double divisor )
	{
		return service->divide( dividend, divisor );
	}
    
	co::int32 callIncrementInt( rpcTests::ISimpleTypes* service, co::int32 number )
	{
		return service->incrementInt( number );
	}
    
    co::int32 parentCall( rpcTests::ISimpleTypes* service, co::int32 number )
	{
		return service->incrementInt( number );
	}
    
	const std::string& concatenateString( rpcTests::ISimpleTypes* service, const std::string& str1, const std::string& str2 )
	{
		_storedString = service->concatenateString( str1, str2 );
        return _storedString;
	}

	// ------ rpcTests.ISimpleTypes Methods ------ //
...
private:
    ...
    co::RefPtr<rpcTests::ISimpleTypes> _storedParentSimple;
