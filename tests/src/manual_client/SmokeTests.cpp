...
TEST( SmokeTests, clientServerSpaceTests )
{
	...
	co::IObject* controlObj = node->findRemoteInstance( "rpcTests.TestComponent", "control", "tcp://localhost:4020" );
	

	co::RefPtr<rpcTests::ISimpleTypes> control = controlObj->getService<rpcTests::ISimpleTypes>();
