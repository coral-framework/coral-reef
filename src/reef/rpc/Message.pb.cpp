...
void protobuf_AddDesc_Message_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\rMessage.proto\022\010reef.rpc\"\263\003\n\007Message\022\032\n"
    ...
    "\n\texception\030\007 \001(\0132\023.reef.rpc.Exception\"\266"
    ...
    "w_instance_type\030\002 \001(\t\022\022\n\nlookup_key\030\003 \001("
    "\t\022\031\n\021lease_instance_id\030\004 \001(\r\"~\n\tExceptio"
    "n\022&\n\004type\030\001 \002(\0162\030.reef.rpc.Exception.Typ"
    ...
    "t_idx\030\002 \002(\r\022\022\n\nmember_idx\030\003 \002(\r\022\022\n\ntype_"
    "depth\030\004 \002(\005\022\r\n\005synch\030\005 \002(\010\022#\n\006params\030\006 \003"
    "(\0132\023.reef.rpc.Parameter\"3\n\tParameter\022&\n\t"
    "container\030\001 \003(\0132\023.reef.rpc.Container\"\264\001\n"
    "\tContainer\022\017\n\007boolean\030\001 \001(\010\022\013\n\003str\030\002 \001(\t"
    "\022\017\n\007numeric\030\003 \001(\001\022,\n\014complex_type\030\004 \001(\0132"
    "\026.reef.rpc.Complex_Type\022$\n\010any_type\030\005 \001("
    "\0132\022.reef.rpc.Any_Type\022$\n\010ref_type\030\006 \001(\0132"
    "\022.reef.rpc.Ref_Type\"J\n\010Any_Type\022\014\n\004kind\030"
    "\001 \002(\005\022\014\n\004type\030\002 \001(\t\022\"\n\005param\030\003 \001(\0132\023.ree"
    "f.rpc.Parameter\"2\n\014Complex_Type\022\"\n\005field"
    "\030\001 \003(\0132\023.reef.rpc.Parameter\"\314\001\n\010Ref_Type"
    "\022\'\n\005owner\030\001 \002(\0162\030.reef.rpc.Ref_Type.Owne"
    ...
    "WNER_RECEIVER\020\001\022\021\n\rOWNER_ANOTHER\020\002", 1394);
...
void Container::InitAsDefaultInstance() {
  ...
  any_type_ = const_cast< ::reef::rpc::Any_Type*>(&::reef::rpc::Any_Type::default_instance());
...
void Container::MergeFrom(const Container& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_any_type()) {
      mutable_any_type()->::reef::rpc::Any_Type::MergeFrom(from.any_type());
    }
...
void Any_Type::InitAsDefaultInstance() {
  param_ = const_cast< ::reef::rpc::Parameter*>(&::reef::rpc::Parameter::default_instance());
}
...
void Any_Type::MergeFrom(const Any_Type& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_param()) {
      mutable_param()->::reef::rpc::Parameter::MergeFrom(from.param());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
